...
{
  "devDependencies": {
    "rosaenlg-loader": "null/app#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/null/app).
